...
class _AddWalletScreenState extends State<AddWalletScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text('إضافة محفظة جديدة')),
      body: SafeArea(
              ...
              child: Column(
                ...
                children: [
                        ...
                        Row(
                          ...
                          children: [
                            ...
                            Container(
                              ...
                              child: Text(
                                AppConstants.walletTypes[_selectedType] ??
                                    'محفظة',
                  ...
                  TextFormField(
                    ...
                    decoration: InputDecoration(
                      labelText:
                          'الرصيد الافتتاحي (${AppConstants.currencySymbols[_selectedCurrency] ?? "ر.ي"})',
