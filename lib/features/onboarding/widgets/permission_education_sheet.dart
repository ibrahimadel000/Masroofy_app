...
enum PermissionEducationType { sms, battery }

class PermissionEducationSheet extends StatefulWidget {
  final PermissionEducationType type;

  const PermissionEducationSheet({super.key, required this.type});
  ...
  @override
  State<PermissionEducationSheet> createState() =>
      _PermissionEducationSheetState();
}
          ...
          child: Column(
            ...
            children: [
              ...
              Container(
                ...
                child: Column(
                  children: _isSms
                      ? _buildSmsAssurances(isDark)
                      : _buildBatteryAssurances(isDark),
                ),
              ),
  ...
  List<Widget> _buildSmsAssurances(bool isDark) {
    return [
      _buildAssuranceRow(
        ...
        description:
            'المعالجة تتم بالكامل داخل هاتفك محلياً. لا نرفع أي رسالة لسيرفر خارجي أبداً.',
        isDark: isDark,
      ),
      ...
      _buildAssuranceRow(
        ...
        description:
            'نتجاهل رسائلك ومحادثاتك الشخصية تلقائياً؛ نقرأ فقط إشعارات البنوك المعتمدة.',
        isDark: isDark,
      ),
      const Divider(height: 16),
      _buildAssuranceRow(
        ...
        description:
            'تسجيل المصاريف والإيداعات تلقائياً مع كل عملية دون الحاجة للكتابة اليدوية.',
        isDark: isDark,
      ),
    ];
  }
  ...
  List<Widget> _buildBatteryAssurances(bool isDark) {
    return [
      _buildAssuranceRow(
        ...
        description:
            'التطبيق يظل في خمول تام ولا ينشط إلا لأجزاء من الثانية عند وصول إشعار بنكي.',
        isDark: isDark,
      ),
      const Divider(height: 16),
      _buildAssuranceRow(
        ...
        description:
            'أندرويد قد يوقف التطبيقات لتوفير الطاقة، هذا الإذن يبقي تحديث رصيدك سريعاً ودقيقاً.',
        isDark: isDark,
      ),
    ];
  }
